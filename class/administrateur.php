...
class administrateur{
	...
	private function getAdministrateur_nom($administrateur_nom){$this->administrateur_nom = $administrateur_nom;}
	private function getAdministrateur_prenom($administrateur_prenom){$this->administrateur_prenom = $administrateur_prenom;}
	private function getAdministrateur_mot_de_passe_hash($administrateur_mot_de_passe_hash){$this->administrateur_mot_de_passe_hash = $administrateur_mot_de_passe_hash;}
	private function getAdministrateur_email($administrateur_email){$this->administrateur_email = $administrateur_email;}
	private function getAdministrateur_telephone($administrateur_telephone){$this->administrateur_telephone = $administrateur_telephone;}
	private function getAdministrateur_adresse($administrateur_adresse){$this->administrateur_adresse = $administrateur_adresse;}
	private function getAdministrateur_ville($administrateur_ville){$this->administrateur_ville = $administrateur_ville;}
	private function getAdministrateur_code_postal($administrateur_code_postal){$this->administrateur_code_postal = $administrateur_code_postal;}
	private function getAdministrateur_derniere_connexion($administrateur_derniere_connexion){$this->administrateur_derniere_connexion = $administrateur_derniere_connexion;}
	private function getAdministrateur_date_ajout($administrateur_date_ajout){$this->administrateur_date_ajout = $administrateur_date_ajout;}
