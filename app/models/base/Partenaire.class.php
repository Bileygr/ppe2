...
;	private $partenaire_telephone;
	...
	public function toString(){
		echo "Partenaire [Partenaire_id= ".$this->partenaire_id.", Partenaire_SIRET= ".$this->partenaire_siret.", Partenaire_nom= ".$this->partenaire_nom.", Partenaire_mot_de_passe_hash= ".$this->partenaire_mot_de_passe_hash.", Partenaire_telephone= ".$this->partenaire_telephone.", Partenaire_email= ".$this->partenaire_email.", Partenaire_adresse= ".$this->partenaire_adresse.", Partenaire_ville= ".$this->partenaire_ville.", Partenaire_code_postal= ".$this->partenaire_code_postal.", Partenaire_derniere_connexion= ".$this->partenaire_derniere_connexion.", Partenaire_creation= ".$this->partenaire_creation."]";
	}
}
?>