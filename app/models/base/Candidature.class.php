...
class Candidature{
	...
	function __construct($candidature_id, $offre_id, $formation_id, $jeune_id, $partenaire_id, $status, $candidature_creation){
	...
	public function setCandidature_creation($candidature_creation){return $this->candidature_creation= $candidature_creation;}

	public function toString(){
		echo "Candidature [Candidature_id= ".$this->candidature_id.", Offre_id= ".$this->offre_id.", formation_id= ".$this->formation_id.", Jeune_id= ".$this->jeune_id.", Partenaire_id= ".$this->partenaire_id.", Status= ".$this->status.", Candidature_creation= ".$this->candidature_creation."]";
	}
}
?>