...
class Administrateur{
	...
	public function setAdministrateur_creation($administrateur_creation){return $this->administrateur_creation= $administrateur_creation;}

	public function toString(){
		echo "Administrateur [Administrateur_id= ".$this->administrateur_id.", Administrateur_super= ".$this->administrateur_super.", Administrateur_nom= ".$this->administrateur_nom.", Administrateur_prenom= ".$this->administrateur_prenom.", Administrateur_mot_de_passe_hash= ".$this->administrateur_mot_de_passe_hash.", Administrateur_telephone= ".$this->administrateur_telephone.", Administrateur_email= ".$this->administrateur_email.", Administrateur_adresse= ".$this->administrateur_adresse.", Administrateur_ville= ".$this->administrateur_ville.", administrateur_code_postal= ".$this->administrateur_code_postal.", Administrateur_derniere_connexion= ".$this->administrateur_derniere_connexion.", Administrateur_creation= ".$this->administrateur_creation."]";
	}
}
?>