...
class Jeune{
	...
	function __construct($jeune_id, $jeune_nom, $jeune_prenom, $jeune_mot_de_passe_hash, $jeune_telephone, $jeune_email, $jeune_adresse, $jeune_ville, $jeune_code_postal, $jeune_derniere_connexion, $jeune_creation){
	...
	public function toString(){
		echo "Jeune [Jeune_id= ".$this->jeune_id.", Jeune_nom= ".$this->jeune_nom.", Jeune_prenom= ".$this->jeune_prenom.", Jeune_mot_de_passe_hash= ".$this->jeune_mot_de_passe_hash.", Jeune_telephone= ".$this->jeune_telephone.", Jeune_email= ".$this->jeune_email.", Jeune_adresse= ".$this->jeune_adresse.", Jeune_ville= ".$this->jeune_ville.", Jeune_code_postal= ".$this->jeune_code_postal.", Jeune_derniere_connexion= ".$this->jeune_derniere_connexion.", Jeune_creation= ".$this->jeune_creation."]";
	}
}
?>