...
class Offre{
	...
	function __construct($offre_id, $partenaire_id, $formation_id, $offre_nom, $offre_description, 
	...
	public function getOffre_nom(){return $this->offre_nom;}
	...
	public function setOffre_nom($offre_titre){return $this->offre_titre = $offre_nom;}
	...
	public function toString(){
		echo "Offre [Offre_id= ".$this->offre_id.", Partenaire_id= ".$this->partenaire_id.", Formation_id= ".$this->formation_id.", Offre_nom= ".$this->offre_nom.", Offre_description= ".$this->offre_description.", Offre_debut= ".$this->offre_debut.", Offre_fin= ".$this->offre_fin.", Offre_creation= ".$this->offre_creation."]";
	}
}
?>