 ...
 */
final class Version20190216084807 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, idoffre_id INT NOT NULL, iduserjeune_id INT NOT NULL, iduserpartenaire_id INT NOT NULL, status INT DEFAULT NULL, INDEX IDX_E33BD3B8E61D1857 (idoffre_id), INDEX IDX_E33BD3B87F78CE6B (iduserjeune_id), INDEX IDX_E33BD3B88022D62 (iduserpartenaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
