...
Class CandidatureDAO implements CandidatureInterface{
	public function accepter($id){
		...
		$requete=$connexion->prepare("UPDATE candidature SET status = 1 WHERE candidature_id = ?");
	...
	public function ajouter($candidature){
		...
		$requete=$connexion->prepare("INSERT INTO candidature(offre_id, formation_id, jeune_id, partenaire_id, status, candidature_creation) VALUES(?, ?, ?, ?, 0, NOW())");
